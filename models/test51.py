...
class Adapter(nn.Module):
    def __init__(self,
        ...
        # self.adapter_rescale = nn.Parameter(torch.empty(1, self.down_size))
        # self.adapter_bias = nn.Parameter(torch.empty(self.n_embd))
        ...
        self.adapter_conv = MonaOp(self.down_size)
